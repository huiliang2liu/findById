...
public class LayoutUtil {
     ...
     * @return
     */
    public static ArrayList<FieldEntity> getIDsFromLayout(final PsiFile file) {
        final ArrayList<FieldEntity> elements = new ArrayList<FieldEntity>();
     ...
     * @return
     */
    public static ArrayList<FieldEntity> getIDsFromLayout(final PsiFile file, final ArrayList<FieldEntity> elements) {
        file.accept(new XmlRecursiveElementVisitor() {
            ...
            public void visitElement(final PsiElement element) {
                ...
                if (element instanceof XmlTag) {
                    ...
                    try {
                        FieldEntity e = new FieldEntity(name, value.substring(5));
                        elements.add(e);
